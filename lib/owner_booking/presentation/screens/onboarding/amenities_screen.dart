...
class _AmenitiesScreenState extends State<AmenitiesScreen> {
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: AppText(
                  text:
                      "Venues with 8+ amenities get 2x more bookings on CricBook",
                  size: 13,
  ...
  List<String> _getGroupKeys(String group) {
    switch (group) {
      ...
      case 'food':
        return ['cafeteria', 'vending_machine', 'water_dispenser'];
      case 'safety':
        return ['cctv', 'security_guard', 'first_aid', 'fire_safety'];
      case 'tech':
        return [
          'wifi',
          'live_scoring',
      ...
      case 'football':
        return ['football_rental', 'goal_nets', 'bibs'];
      default:
        return [];
    }
  }
  ...
  bool _hasCricket() {
    return _sportsConfig.containsKey('box_cricket') ||
        _sportsConfig.containsKey('cricket');
  }

  bool _hasFootball() {
    return _sportsConfig.containsKey('football') ||
        _sportsConfig.containsKey('futsal');
  }
  ...
  Widget _buildAmenityTile(String key, String title) {
    return Container(
      ...
      child: SwitchListTile(
        ...
        activeThumbColor: AppColors.primaryLightGreen,
